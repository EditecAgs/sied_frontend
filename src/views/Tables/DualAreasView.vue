<template>
	<AdminLayout>
		...
		<div class="space-y-5 sm:space-y-6">
			<ComponentCard title="Catálogo de Clasificaciones Generales del Proyecto Dual">
				<btn-create :table="'Clasificación General del Proyecto Dual'" @open="({ mode, pk, table}) => openModal(mode, pk, table)" class="divide-error-900 hover:divide-error-800" />
				<mdlDualArea
					:show="showModal"
					:data="modalData"
					@close="closeModal"
...
const currentPageTitle = ref("Clasificaciones Generales");
