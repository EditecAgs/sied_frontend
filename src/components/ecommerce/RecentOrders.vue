<template>
	<div
		...
		<div class="flex flex-col gap-4 mb-6 sm:flex-row sm:items-center sm:justify-between">
			...
			<nav class="inline-flex rounded-md shadow-sm" role="navigation" aria-label="Pagination">
				<button
					...
					class="relative inline-flex items-center rounded-l-md border border-gray-300 bg-white/80 backdrop-blur-sm
                           px-3 py-1 text-sm font-medium text-gray-700 hover:bg-gray-100
                           disabled:cursor-not-allowed disabled:opacity-50
                           dark:border-gray-700 dark:bg-gray-800/80 dark:text-gray-300 dark:hover:bg-gray-700"
				...
				<button
					...
					class="relative -ml-px inline-flex items-center rounded-r-md border border-gray-300 bg-white/80 backdrop-blur-sm
                           px-3 py-1 text-sm font-medium text-gray-700 hover:bg-gray-100
                           disabled:cursor-not-allowed disabled:opacity-50
                           dark:border-gray-700 dark:bg-gray-800/80 dark:text-gray-300 dark:hover:bg-gray-700"
			...
			<table class="min-w-full table-auto divide-y divide-gray-200 dark:divide-gray-700">
				<thead class="bg-gray-100/70 dark:bg-gray-800/80">
					<tr>
						<th
							scope="col"
							class="py-3 px-4 text-left text-xs font-semibold uppercase text-gray-600 dark:text-gray-400 max-w-[350px]">
							Sector
						</th>
						<th
							scope="col"
							class="py-3 px-4 text-right text-xs font-semibold uppercase text-gray-600 dark:text-gray-400 w-40">
							Número de Proyectos
						</th>
					</tr>
				</thead>
		...
		<p class="mt-4 text-center text-sm text-gray-600 dark:text-gray-400" aria-live="polite">
