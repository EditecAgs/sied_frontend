...
const fieldHelpTexts: Record<string, string> = {
	...
	hours: "Número de horas que representa la microcredencial.",
	type: "Tipo de microcredencial: Académico o No Académico."
}
							...
							<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
								<div>
									...
									<input
										...
										class="input"
										:disabled="isLoading"
										placeholder="Ingresa el nombre de la microcredencial" />
								</div>
								...
								<div class="md:col-span-2">
									...
									<textarea
										...
										:disabled="isLoading"
										placeholder="Describe el propósito y contenido de la microcredencial" />
								</div>
							</div>
						</div>
						...
						<div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
							...
							<div>
								...
								<div v-else class="mt-4 text-center py-8 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50">
									...
									<p class="text-sm text-gray-500">Selecciona una imagen para la insignia</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="flex justify-end gap-3 mt-6 pt-6 border-t border-gray-200 sticky bottom-0 bg-white/95 backdrop-blur-sm z-10 rounded-b-2xl -mx-8 -mb-8 px-8 py-4">
					...
					<button
						...
						<span class="flex items-center gap-2">
							...
							{{ isLoading ? 'Guardando...' : 'Guardar Microcredencial' }}
						</span>
					</button>
				</div>
			</div>
