			...
			<div class="bg-white rounded-3xl shadow-2xl w-full max-w-lg p-8 relative max-h-[85vh] flex flex-col overflow-hidden">
				...
				<div class="flex justify-center mb-4">
					<template v-if="success">
						<svg class="w-12 h-12 text-green-700" fill="none" stroke="currentColor" stroke-width="3"
					...
					<template v-else-if="error">
						<svg class="w-12 h-12 text-red-700" fill="none" stroke="currentColor" stroke-width="2"
							viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
					...
					<template v-else>
						<svg class="w-12 h-12 text-brand-900" fill="none" stroke="currentColor" stroke-width="2"
							viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
...
import { removeBenefitType } from "../../../services/dual_projects/BenefitType"
